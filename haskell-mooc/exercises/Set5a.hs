...
tick :: UpDown -> UpDown
tick (MkUp n) = MkUp (n + 1)
tick (MkDown n) = MkDown (n - 1)

-- toggle changes an increasing counter into a decreasing counter and
-- vice versa
toggle :: UpDown -> UpDown
toggle (MkUp n) = MkDown n
toggle (MkDown n) = MkUp n
...
toBin 0 = O End
toBin 1 = I End
toBin n = if n `mod` 2 == 0 then O (toBin (n `div` 2)) else I (toBin (n `div` 2))
